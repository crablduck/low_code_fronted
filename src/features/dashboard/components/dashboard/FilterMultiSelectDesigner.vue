<template>
  <div class="filter-multiselect-designer">
    <div v-if="isDesignMode" class="design-mode">
      <div class="filter-preview">
        ...
        <el-select 
          :placeholder="config.placeholder || '请选择多个选项'"
          disabled
          multiple
          style="width: 100%"
        >
...
const currentValue = ref<any[]>(props.modelValue || props.config.defaultValue || [])
