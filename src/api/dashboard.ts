 ...
 */
import type { DashboardForm, DashboardQuery, DashboardResponse, DashboardListResponse, DashboardItem } from '@/shared/types/dashboard'
import { mainService as request } from '@/shared/utils/request'
